...
namespace Folferine.Website.Controllers
{
    ...
    {
        public AccountController() : this(new UserManager<Player>(new UserStore<Player>(new FolferineContext())))
        {
        }
        ...
        private async Task SignInAsync(Player player, bool isPersistent)
        {
            AuthenticationManager.SignOut(DefaultAuthenticationTypes.ExternalCookie);
            var identity = await UserManager.CreateIdentityAsync(player, DefaultAuthenticationTypes.ApplicationCookie);
